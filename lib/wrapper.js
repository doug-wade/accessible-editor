...
async function initContainer() {
  ...
  const p = await webcontainerInstance.spawn('npm', ['run', 'install', '--prefix', 'node_modules/puppeteer']);
  ...
  const ls = await webcontainerInstance.spawn('ls', ['-al', 'node_modules/puppeteer']);
